...
### 11. CHANGELOG
  ...
  - **v1.3.0 — [2026-04-03]** — Upgraded architecture with `framer-motion` to inject smooth, staggered micro-animations and scroll effects across `HeroSlider`, `DepartmentsGrid`, `Leadership`, and `CitizenServices`. Further optimized Tailwind layouts to ensure scalable robustness across mobile grids and viewports.
---
